...
# TODO: Entferne Path aus Parametervorgaben
def load_and_preprocess_logistics_data(random_state=None, max_samples=None, return_column_names=False):
    ...
    file_path_a = f'/Users/sanaemessoudi/Desktop/Projekte/PAMI_Projekt9/Shift Explantion/00_simulate_data/Output Customer Data/customer_profile_0.csv'
    file_path_b = f'/Users/sanaemessoudi/Desktop/Projekte/PAMI_Projekt9/Shift Explantion/00_simulate_data/Output Customer Data/customer_profile_1.csv'
    ...
    source_data = data_a[data_a["Week"] == 1]
    target_data = data_b[data_b["Week"] == 1]
